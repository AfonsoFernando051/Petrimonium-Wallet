...
class Translator {
  ...
  static const Map<String, Map<String, String>> _localizedValues = {
    'pt': {
      ...
      AppStrings.addAssetFooterNote:
          "Você pode registrar compras antigas — a data ajuda a calcular seu retorno real.",
      ...
      AppStrings.addAssetLoadFailedBanner: "Não foi possível carregar sua carteira atual.",
    ...
    'en': {
      ...
      AppStrings.addAssetFooterNote:
          "You can register old purchases — the date helps calculate your real return.",
      ...
      AppStrings.addAssetLoadFailedBanner: "Couldn't load your current portfolio.",
    ...
    'es': {
      ...
      AppStrings.addAssetFooterNote:
          "Puedes registrar compras antiguas — la fecha ayuda a calcular tu retorno real.",
      ...
      AppStrings.addAssetLoadFailedBanner: "No se pudo cargar tu cartera actual.",
      AppStrings.proventosTitle: "Proventos",
